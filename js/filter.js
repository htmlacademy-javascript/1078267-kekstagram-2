...
function applyFilter() {
  ...
  if (currentFilter === Filter.RANDOM) {
    filteredPictures = photos.toSorted(SortFunc.GET_RANDOM_PREVIEWS).slice(0, MAX_PICTURE_COUNT);
  }
  if (currentFilter === Filter.DISCUSSED) {
    filteredPictures = photos.toSorted(SortFunc.GET_DISCUSSED_PREVIEWS);
  }
